...
function create_layout__MC_ONE_OF_COMB(COMB, MC_COMBINED_TITLE, i) {
  ...
  h_m_bottem_playlist_two_upper.classList.add(
    `h_m_bottem_playlist_two_upper-${i}`
  );
  ...
  h_m_bottem_playlist_two_upper.style.border =
    "1px solid rgb(42, 165, 63, 000)";
  ...
  h_m_bottem_playlist_two_upper_title.classList.add(
    `h-m-bottem-playlist-two-upper-title-${i}`
  );
  h_m_bottem_playlist_two_upper_title.classList.add(
    `h-m-bottem-playlist-two-upper-title`
  );
  ...
  h_m_bottem_playlist_two_upper_title.onclick = function () {
    show_about_this(i, COMB, MC_COMBINED_TITLE[i]);
  };
  h_m_bottem_playlist_two_upper_title.style.margin = `10px 0px 0px 20px`;
  h_m_bottem_playlist_two_upper.appendChild(
    h_m_bottem_playlist_two_upper_title
  );

  let h_m_bottem_playlist_two_upper_smore = document.createElement("p");
  h_m_bottem_playlist_two_upper_smore.classList.add(
    `h-m-bottem-playlist-two-upper-smore-${i}`
  );
  h_m_bottem_playlist_two_upper_smore.classList.add(
    `h-m-bottem-playlist-two-upper-smore`
  );
  ...
  h_m_bottem_playlist_two_upper_smore.onclick = function () {
    show_about_this(i, COMB, MC_COMBINED_TITLE[i]);
  };
  ...
  h_m_bottem_playlist_two_upper.appendChild(
    h_m_bottem_playlist_two_upper_smore
  );

  // ---------------------LOWER---SEC--------------
  let h_mb_bottem_playlist_two_lower = document.createElement("div");
  h_mb_bottem_playlist_two_lower.classList.add(
    `h-mb-bottem-playlist-two-lower`
  );
  h_mb_bottem_playlist_two_lower.classList.add(
    `h-mb-bottem-playlist-two-lower-${i}`
  );
  ...
  for (let j = 0; j < COMB.length; j++) {
    ...
    h_mb_bottem_playlist_two_lower_boxes.classList.add(
      `h-mb-bottem-playlist-two-lower-boxes-${j}`
    );
    h_mb_bottem_playlist_two_lower_boxes.classList.add(
    ...
    h_mb_bottem_playlist_two_lower.appendChild(
      h_mb_bottem_playlist_two_lower_boxes
    );

    if (COMB[j].hasOwnProperty("img")) {
      let h_mb_bottem_playlist_two_lower_boxes_imgbox =
        document.createElement("div");
      h_mb_bottem_playlist_two_lower_boxes_imgbox.classList.add(
        `h-mb-bottem-playlist-two-lower-boxes-imgbox-${j}`
      );
      // class = "h_mb_bottem_playlist_two_lower_boxes_imgbox-1"
      h_mb_bottem_playlist_two_lower_boxes_imgbox.style.height = "160px";
      h_mb_bottem_playlist_two_lower_boxes_imgbox.style.width =
        "calc(100% - 10px)";
      h_mb_bottem_playlist_two_lower_boxes_imgbox.style.border =
        "1px solid #ff000000";
      h_mb_bottem_playlist_two_lower_boxes_imgbox.style.borderRadius =
        "10px 10px 0px 0px";
      ...
      h_mb_bottem_playlist_two_lower_boxes.appendChild(
        h_mb_bottem_playlist_two_lower_boxes_imgbox
      );
    }

    // if(COMB[j].hasOwnProperty('name')){
    let h_mb_bottem_playlist_two_lower_boxes_h4 = document.createElement("h4");
    h_mb_bottem_playlist_two_lower_boxes_h4.classList.add(
      `h-mb-bottem-playlist-two-lower-boxes-h4-${j}`
    );
    ...
    h_mb_bottem_playlist_two_lower_boxes.appendChild(
      h_mb_bottem_playlist_two_lower_boxes_h4
    );
    // }

    if (COMB[j].hasOwnProperty("cast")) {
      let h_mb_bottem_playlist_two_lower_boxes_p = document.createElement("p");
      h_mb_bottem_playlist_two_lower_boxes_p.classList.add(
        `h-mb-bottem-playlist-two-lower-boxes-p-${j}`
      );
      ...
      for (let i = 0; i < 2; i++) {
        let h_mb_bottem_playlist_two_lower_boxes_p2 =
          document.createElement("p");
        h_mb_bottem_playlist_two_lower_boxes_p2.classList.add(
          `h-mb-bottem-playlist-two-lower-boxes-p2-${j}-${i}`
        );
        h_mb_bottem_playlist_two_lower_boxes_p2.classList.add(
          `h-mb-bottem-playlist-two-lower-boxes-p2`
        );
        // class = "h-mb-bottem-playlist-two-lower-boxes-p2-3-1" "h-mb-bottem-playlist-two-lower-boxes-p2"
        h_mb_bottem_playlist_two_lower_boxes_p2.style.margin =
          "-30px 0px 0px 0px";
        ...
        h_mb_bottem_playlist_two_lower_boxes_p.appendChild(
          h_mb_bottem_playlist_two_lower_boxes_p2
        );
      ...
      h_mb_bottem_playlist_two_lower_boxes.appendChild(
        h_mb_bottem_playlist_two_lower_boxes_p
      );
    }

    let h_mb_bottem_playlist_two_lower_boxes_svg =
      document.createElement("div");
    h_mb_bottem_playlist_two_lower_boxes_svg.classList.add(
      `h-mb-bottem-playlist-two-lower-boxes-svg-${j}`
    );
    h_mb_bottem_playlist_two_lower_boxes_svg.classList.add(
    ...
    h_mb_bottem_playlist_two_lower_boxes.appendChild(
      h_mb_bottem_playlist_two_lower_boxes_svg
    );
  }
}
...
function show_about_this(num, COMB, titles) {
  ...
  s_a_t_top_bbtn.onclick = function () {
    back_to_home();
  };
...
function media_res_effects_on_playlist_boxes() {
  for (let i = 0; i < MC_COMBINED_CONTENT.length; i++) {
    const parentBox = document.querySelector(
      `.h-mb-bottem-playlist-two-${i} .h-mb-bottem-playlist-two-lower`
    );
    let w = parentBox.getBoundingClientRect().width;
    // console.log("Current width of parent box:", w);
    let box0 = document.querySelector(
      `.h-mb-bottem-playlist-two-${i} .h-mb-bottem-playlist-two-lower-boxes-0`
    );
    let box1 = document.querySelector(
      `.h-mb-bottem-playlist-two-${i} .h-mb-bottem-playlist-two-lower-boxes-1`
    );
    let box2 = document.querySelector(
      `.h-mb-bottem-playlist-two-${i} .h-mb-bottem-playlist-two-lower-boxes-2`
    );
    let box3 = document.querySelector(
      `.h-mb-bottem-playlist-two-${i} .h-mb-bottem-playlist-two-lower-boxes-3`
    );
    let box4 = document.querySelector(
      `.h-mb-bottem-playlist-two-${i} .h-mb-bottem-playlist-two-lower-boxes-4`
    );
    let box5 = document.querySelector(
      `.h-mb-bottem-playlist-two-${i} .h-mb-bottem-playlist-two-lower-boxes-5`
    );
...
function media_res_effects() {
  for (let i = 0; i < MC_COMBINED_CONTENT.length; i++) {
    let h_m_bottem_playlist_two_upper_smore = document.querySelectorAll(
      `.h-m-bottem-playlist-two-upper-smore-${i}`
    );
    let h_m_bottem_playlist_two_upper_title = document.querySelectorAll(
      `.h-m-bottem-playlist-two-upper-title-${i}`
    );
    let h_m_bottem_playlist_two_upper = document.querySelectorAll(
      `.h_m_bottem_playlist_two_upper-${i}`
    );
    let h_mb_bottem_playlist_two_lower = document.querySelectorAll(
      `.h_mb_bottem_playlist_two_lower-${i}`
    );
